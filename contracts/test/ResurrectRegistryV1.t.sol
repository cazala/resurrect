...
contract ResurrectRegistryV1Test is TestBase {
    ...
    function testTtlZeroReverts() public {
        vm.expectRevert(ResurrectRegistryV1.InvalidTTL.selector);
    ...
    function testEmptyRecordReverts() public {
        vm.expectRevert(ResurrectRegistryV1.RecordTooLarge.selector);
