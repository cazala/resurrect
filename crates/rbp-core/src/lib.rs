//! Protocol-independent primitives for Rebootable Bootstrap Protocol v1.
//!
...
pub use descriptor::{DescriptorError, NetworkDescriptor, RBP_VERSION, RegistryDescriptor};
