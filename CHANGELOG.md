...
- Immutable, stateless, permissionless `RBPRegistryV1` with Foundry example, fuzz, invariant, and optional fork suites.
- Strict RBP v1 descriptor and namespace primitives, signed announcement validation, sequence deduplication, deterministic bounded candidate selection, and caller-owned interfaces.
...
- End-to-end Anvil implementer-checklist test covering total extinction, RBP-only recovery, registry-independent native joining, unrelated-operator reboot, and simultaneous reboot.
